...
id.place(x=70,y=30)
id=Entry(entres_fram,width=10,font=('Aptos',8))
id.place(x=85,y=30)
...
enPart=ttk.Combobox(entres_fram,textvariable=Descrption,font=('Times New Roman (Headings CS)',8),width=13,state='readonly')
...
delet_button =Button(button_lbl, text="Reset",width=8,bg="#bf5b5a")
...
update_button =Button(button_lbl, text="Update Job",width=8,bg="#16a085")
...
#table
table=Frame(root,bg='white',width=1410,height=580).place(x=-190,y=210)

style=ttk.Style()
style.configure("mystyle.Treeview",font=('calibri',6),rowheight=1)
...
tv.column("12",width="89")

tv.heading("13",text="Date")
tv.column("13",width="100")

tv.heading("14",text="Job_NUM")
tv.column("14",width="100")

tv.place(x=-200,y=210)
